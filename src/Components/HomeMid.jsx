...
export default function HomeMid() {
  ...
  return (
    <div className="flex w-1/2 justify-between gap-8 flex-col">
      <div>
        <button className="shadow-md hover:shadow-lg transition-all duration-300 animate-updateBtn w-full py-2 border-2 cursor-pointer rounded-md">
      ...
      <div className="flex w-full justify-between gap-2">
        <button
          ...
          className="flex flex-col border-2 p-2 px-16 w-1/2 rounded-md transition-all duration-150 cursor-pointer hover:bg-bg2 hover:text-f1"
        >
